...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @csrf
                    ...
                    <label for="name">Naziv proizvoda:</label><br>
                        ...
                        <label for="price">Velicina proizvoda:</label><br>
                        <input type="text" name="size"><br>
                        <label for="producer_id">Proizvodjac:</label><br>
                        <input type="text" name="producer_id"><br>
                        <label for="category_id">Kategorija:</label><br>
                        <input type="text" name="category_id"><br>
                    </div>

                    <div class="form-group">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Dodaj proizvod</button>
                    </div>
